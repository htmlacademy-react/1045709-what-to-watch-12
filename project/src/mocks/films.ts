...
export const films: Film[] = [
  {
    ...
    filmInfo: {
      ...
      posterSrc: '/project/public/img/what-we-do-in-the-shadows.jpg',
  ...
  },
  {
    ...
    filmInfo: {
      ...
      posterSrc: '/project/public/img/we-need-to-talk-about-kevin.jpg',
  ...
  },
  {
    ...
    filmInfo: {
      ...
      posterSrc: '/project/public/img/no-country-for-old-men.jpg',
      videoSrc: 'videoSrc',
      genre: 'genre',
      director: 'Rick',
      actors: ['Egor', 'Artem']
  ...
  },
  {
    ...
    filmInfo: {
      ...
      posterSrc: '/project/public/img/bg-the-grand-budapest-hotel.jpg',
      videoSrc: 'videoSrc',
      genre: 'genre',
      director: 'Takeshi',
      actors: ['Tom', 'Rolan']
